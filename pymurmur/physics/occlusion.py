...
P4.6 Stage 2 culling-strategy dispatch (sequential/chunk/parallel) moved
to occlusion_culling.py (file-size split of this file).
"""
...
from .occlusion_culling import _culling_parallel, _culling_sequential
