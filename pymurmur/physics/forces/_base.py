...
Separation-specific kernel dispatch and separation_force moved to
separation_primitives.py (file-size split of this file) — imported
back below since composeForces/mode files still reach separation_force
through this module.
"""
