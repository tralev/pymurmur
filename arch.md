...
(`test/crosscutting/guards/architecture/test_architecture_edges*.py`). `test/l3_subsystems/`
...
## 5. Dependency Rules *(Level 2 — enforced by `test/crosscutting/guards/architecture/test_architecture_edges*.py`)*
