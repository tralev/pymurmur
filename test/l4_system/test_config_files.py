...
Modular-axis coverage guards (every kernel/extension/noise_mode/
velocity_init/.../bird_mesh value appears in some preset) split out to
test_config_axis_coverage.py (file-size split) — that file grew to hold
its own registry/hardcoded-set-driven "*_has_example_coverage" family
across three rounds of DeepSeek-flagged conf/examples coverage work.
"""
