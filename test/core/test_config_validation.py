...
def test_unknown_mode_rejected():
    _assert_invalid(SimConfig(mode="angle"), "mode")
...
def test_projection_negative_phi_p_rejected():
    _assert_invalid(SimConfig(mode="projection", phi_p=-0.01), "phi_p")
...
def test_alignment_radius_ratio_out_of_range_rejected():
    _assert_invalid(SimConfig(alignment_radius_ratio=0.0), "alignment_radius_ratio")
    _assert_invalid(SimConfig(alignment_radius_ratio=1.5), "alignment_radius_ratio")


def test_alignment_radius_ratio_boundary_accepted():
    _assert_valid(SimConfig(alignment_radius_ratio=0.01))
    _assert_valid(SimConfig(alignment_radius_ratio=1.0))
