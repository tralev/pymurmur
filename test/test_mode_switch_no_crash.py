...
# angle and marl are not yet registered (they ship in P5 and P12)
FUTURE_MODES = ["angle", "marl"]
...
class TestModeSwitchNoCrash:
    ...
    def test_all_seven_modes_cycle_no_crash(self, default_config):
        ...
        angle and marl are marked xfail — they ship in P5 and P12.
        """
        ...
        # 5 active modes × 10 steps = 50 total (angle/marl skipped)
        assert sim.frame == 50
