...
class TestArchitectureWaiversRemoved:
    ...
    def test_flock_to_forces_not_in_known_violations(self):
        ...
        from test.crosscutting.guards.test_architecture_edges_data import KNOWN_VIOLATIONS
    ...
    def test_flock_to_forces_not_in_phase_violation_removals(self):
        ...
        from test.crosscutting.guards.test_architecture_edges_data import PHASE_VIOLATION_REMOVALS
