"""I4 — Full engine pipeline (IT1), paused add/remove/unpause (IT2), command-queue reset preemption (IT3), recorder headless pipeline (IT4), reset invariants (IT5), only-engine dual-importer AST scan (IT6).
...
class TestOnlyEngineDualImporter:
    ...
    def test_only_engine_can_import_both_flock_and_forces(self):
        ...
        """
        from test.crosscutting.guards.architecture.test_architecture_edges import _collect_import_edges
