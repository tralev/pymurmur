...
Named regression edges (from roadmap_deepseek.md P14.1):
...
PHASE_EDGES = {
    ...
    "P2": {
        ...
        "pymurmur.physics.forces.spatial": {"pymurmur.core.types", "pymurmur.physics.forces._base", "pymurmur.physics.flock"},
    ...
    "P8": {
        ...
        "pymurmur.analysis.perf": {"pymurmur.core.types"},
    },
    "P9": {
        "pymurmur.analysis.rewards": {"pymurmur.core.types", "pymurmur.physics.flock"},
    ...
    "P10": {
        "pymurmur.viz.hud": {"pymurmur.core.types"},
