"""P2.2 — ForceMode ABC + MODE_REGISTRY contract tests: ABC, @register decorator, registry completeness, compute_all_forces dispatch, per-mode direct-instantiation tests (Projection/Spatial/Field/Vicsek/Influencer).
