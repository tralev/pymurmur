"""I1.7 — Property tests for cohesion_force and noise_force.

Split out of test_force_primitives_properties.py (file-size split) —
separation_force/alignment_force property tests stay in the original;
this file covers cohesion_force/noise_force.
"""
