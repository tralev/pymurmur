"""I1.7 — Property tests for separation_force and alignment_force.

Fuzzy-tests for documented formula correctness, output shape, bound
enforcement, rng determinism, and vectorised/ragged path equivalence.

Uses hypothesis-style assertions: generate random inputs, assert invariants.

Split out of this file (file-size split): cohesion_force/noise_force
property tests live in
test_force_primitives_properties_cohesion_noise.py.
"""
