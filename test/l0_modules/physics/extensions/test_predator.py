"""P3.8-P3.9 Threat FSM + panic/blackening — unit tests.

Unit tests (L0): _rotate_toward, approach/egress FSM transitions,
force bundle components, panic ceiling, blackening values.

Split out of this file (file-size split): integration-level tests
(full Predator lifecycle through apply(), threat force decay,
panic/blackening end-to-end, zero-active edge case — originally
extracted from test_extensions.py) live in test_predator_integration.py.
"""
