"""Unit tests for analysis.collector (via metrics re-export) — S3.11 EMA readout smoothing.

Split out of test_metrics.py (file-size split). D18 metrics
accelerations and D10 ripple-forces tests moved to
test_collector_metrics_accelerations.py (file-size split of this
file).
"""
