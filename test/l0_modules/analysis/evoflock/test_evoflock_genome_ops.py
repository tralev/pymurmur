"""EvoFlock tests — Phase 11 genome encoding, Pareto front, SSGA update,
worst-of-4 evaluation.

Split out of test_evoflock.py (file-size split) — TestEvoFlock (the
GA-integration class) stays in the original; genome-level operations
(Constants, Genome, Pareto, SSGAUpdate, WorstOfFour) live here.
"""
