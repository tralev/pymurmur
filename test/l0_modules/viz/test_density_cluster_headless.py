"""Unit tests for P8.11 — alpha-accumulation density mode: headless
frame rendering and cluster-centre-darker (murmuratR aesthetic) tests.

Split out of test_density.py (file-size split) — config fields,
renderer init/uniform, blend-state, and Visualizer-forwarding tests
