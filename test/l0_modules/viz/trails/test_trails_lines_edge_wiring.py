"""P8.3 — Trail rendering tests: draw lines (ribbon) mode, edge cases, buffer growth, degenerate inputs, accumulation FBO lifecycle, renderer wiring, ribbon geometry.
